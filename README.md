...
Note: proBait was designed to work on Linux and its usage requires minimal experience with the command line. It may work on Windows machines if you install the [Windows Subsystem for Linux (WSL)](https://learn.microsoft.com/en-us/windows/wsl/install).
